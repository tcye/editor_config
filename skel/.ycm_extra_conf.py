...
compilation_database_folder = '/home/yetiancai/repo/bigo_ml_service/build'
  ...
  if IsHeaderFile( filename ):
    ...
    for extension in SOURCE_EXTENSIONS:
      ...
      if os.path.exists( replacement_file ):
        ret = replacement_file
        break

  if IsHeaderFile( ret ):
    if last_source_file_name:
      ret = last_source_file_name
  else:
    last_source_file_name = ret
  return ret
